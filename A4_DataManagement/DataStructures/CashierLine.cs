...
namespace A4_DataManagement
{
    public sealed class CashierLine : IEntity
    {
        ...
        static CashierLine()
        {
            ...
            {
                cashierLocations[i] = new Vector2(74 + 2 * SharedData.HORIZONTAL_SPACING * i, SharedData.VERTICAL_BUFFER);
                exitLocations[i] = new Vector2(74 + (i % 2 == 0 ? -1 : 1) * SharedData.CUSTOMER_WIDTH + 2 * SharedData.HORIZONTAL_SPACING * i, -SharedData.CUSTOMER_HEIGHT);
            }
        }
